...
Then you have to create a key pair for your IAM user: [![AWS](https://img.shields.io/badge/AWS-Install%20Cli-orange.svg?logo=amazon-aws)](https://docs.aws.amazon.com/cli/latest/userguide/cli-chap-configure.html)
